...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    private AnimationDrawable animationRefresingDrawable;
    ...
    private void initView(Context context) {
        ...
        rotateAnimationBack = (RotateAnimation) AnimationUtils.loadAnimation(context, R.anim.reverse_anim_back);
        refreshingAnimation = (RotateAnimation) AnimationUtils.loadAnimation(context, R.anim.rotating);

        // 添加匀速转动动画
        LinearInterpolator lir = new LinearInterpolator();
        rotateAnimation.setInterpolator(lir);
        rotateAnimationBack.setInterpolator(lir);
    ...
    public void refreshFinish(int refreshResult) {
        animationRefresingDrawable = (AnimationDrawable) refreshingView.getDrawable();
        animationRefresingDrawable.stop();
    ...
    public void loadMoreFinish(int refreshResult) {
        animationLoadingDrawable = (AnimationDrawable) loadingView.getDrawable();
        animationLoadingDrawable.stop();
    ...
    private void changeState(int to) {
        ...
        switch (state) {
            case INIT:
                ...
                pullView.startAnimation(rotateAnimationBack);
                ...
                pullUpView.startAnimation(rotateAnimationBack);
                break;
            ...
            case REFRESHING:
                ...
                animationRefresingDrawable = (AnimationDrawable) refreshingView.getDrawable();
                animationRefresingDrawable.start();
            ...
            case LOADING:
                ...
                animationLoadingDrawable = (AnimationDrawable) loadingView.getDrawable();
                animationLoadingDrawable.start();
